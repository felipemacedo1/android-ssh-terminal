...
import com.felipemacedo.androidsshterminal.ui.components.ErrorDialog
import com.felipemacedo.androidsshterminal.ui.components.LoadingDialog
    ...
    Scaffold(
        ...
        Column(
            ...
            Row(
                ...
                FilterChip(
                    selected = uiState.authMethod == AuthMethod.PUBLIC_KEY,
                    onClick = { viewModel.updateAuthMethod(AuthMethod.PUBLIC_KEY) },
            ...
            if (uiState.authMethod == AuthMethod.PUBLIC_KEY) {
                OutlinedTextField(
